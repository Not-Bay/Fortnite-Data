...
class Settings(commands.Cog):
    ...
    @settings.command(
        name=util.get_str('en', 'command_name_settings_language'),
        name_localizations={
            'es-ES': util.get_str('es', 'command_name_settings_language'),
            'ja': util.get_str('ja', 'command_name_settings_language')
        },
