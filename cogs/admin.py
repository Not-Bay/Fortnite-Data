...
class Admin(commands.Cog):
    ...
    @slash_command(name = 'sync-commands', description = 'Syncs commands', guild_ids=util.configuration.get('admin_guilds'))
    ...
    @slash_command(name = 'restart', description = 'Restarts the bot', guild_ids=util.configuration.get('admin_guilds'))
    @permissions.is_owner()
    async def _restart(
        self,
        ctx: discord.ApplicationContext
    ...
    @slash_command(name = 'reload', description = 'Reloads a cog', guild_ids=util.configuration.get('admin_guilds'))
    @permissions.is_owner()
    async def _reload(
        self,
        ctx: discord.ApplicationContext,
    ...
    @slash_command(name = 'load', description = 'Load a cog', guild_ids=util.configuration.get('admin_guilds'))
    @permissions.is_owner()
    async def _load(
        self,
        ctx: discord.ApplicationContext,
    ...
    @slash_command(name = 'unload', description = 'Unload a cog', guild_ids=util.configuration.get('admin_guilds'))
    @permissions.is_owner()
    async def _unload(
        self,
        ctx: discord.ApplicationContext,
    ...
    @slash_command(name = 'eval', description = 'Evaluates code', guild_ids=util.configuration.get('admin_guilds'))
    @permissions.is_owner()
    async def eval(
        self,
        ctx: discord.ApplicationContext,
